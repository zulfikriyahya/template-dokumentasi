...
<Aside type='tip' title='Naming Convention'>
    **Format yang direkomendasikan:** - Kode: ALL CAPS, no space (contoh: IPA ,
    IPS, AGM) - Nama: Title Case (contoh: Ilmu Pengetahuan Alam) - Singkatan:
    ALL CAPS (contoh: IPA)
</Aside>
...
| **TBSM** | Teknik Bisnis Sepeda Motor          |
  ...
  <TabItem label="Custom">
    Anda bisa membuat kode custom sesuai kebutuhan: 
    **Contoh:** 
      - **MIPA**:
...
<CardGrid>
  ...
  <Card title="Bad" icon="error">
    **Kode:** - IPA (lowercase) ✗ - IPA-2024 (dengan tahun) ✗ - I.P.A. (dengan
    titik) ✗ **Nama:** - IPA (lowercase) ✗ - IPA kelas VII (dengan tingkat) ✗ -
...
<Tabs>
  <TabItem label="Format Standar">
    **Pattern:** `[Tingkat] [Jurusan] [Nomor]` **Contoh:** ``` VII IPA  X IPA 2 X
    IPS 1 VIII IPA 1 VIII IPA 2 XII IPS 1 ```
  </TabItem>
...
<Card title='Relasi Jurusan-Kelas' icon='bars'>
    **1 Jurusan dapat memiliki banyak Kelas:** Contoh Jurusan **IPA**: - VII IPA
    (30 siswa) - X IPA 2 (32 siswa) - VIII IPA 1 (28 siswa) - XI IPA 2 (30
    siswa) - XII IPA 1 (25 siswa) - XII IPA 2 (27 siswa) **Total:** 6 kelas, 172
    siswa
</Card>
