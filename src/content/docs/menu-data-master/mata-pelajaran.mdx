...
<Aside type="tip" title="Contoh Kode">
  ...
  Matematika Wajib - **IPA-FIS** → IPA - Fisika - **BHS-ING** → Bahasa Inggris -
  **MUL-BJW** → Muatan Lokal - Bahasa Jawa - **EKSKUL-THF** → Ekstrakurikuler -
  Tahfidz
</Aside>
...
3. **Isi Data Mata Pelajaran**
   ...
   - **Rumpun** (opsional) - Contoh: MIPA, IPS, Bahasa
...
<TabItem label="Multiple Pengampu">
  **Beberapa Guru untuk Kelas Berbeda** Cocok untuk: - Mapel dengan banyak
  rombel - Pembagian beban mengajar Contoh: - Guru A: Matematika X IPA 1, 2 -
  Guru B: Matematika X IPA 3, 4
</TabItem>
...
Guru Pengampu:
  - Dr. Budi Santoso (X IPA 1, 2)
  - Ir. Siti Aminah (X IPA 3, 4)
Status: Aktif
```
