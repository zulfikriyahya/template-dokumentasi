...
<Aside type="tip" title="Contoh Penamaan">
  - **X IPA 1** → Kelas 10 IPA Rombel 1 - **XI TKJ 2** → Kelas 11 Teknik
  Komputer Jaringan Rombel 2 - **XII IPS 3** → Kelas 12 IPS Rombel 3
</Aside>
...
| ---------------- | ------------------------ | ---------- |
| **Tingkat**      | X, XI, XII (10, 11, 12)  | X, XI, XII |
| **Jurusan**      | IPA, IPS, TKJ, RPL, dll  | IPA, TKJ   |
...
3. **Isi Data Kelas**
   ...
   - **Nama Kelas** (wajib) - Format: X IPA 1
...
<CardGrid>
  <Card title="Kenaikan Tingkat" icon="rocket">
    Perpindahan massal siswa dari kelas X ke XI, atau XI ke XII di akhir tahun
    ajaran
  </Card>
