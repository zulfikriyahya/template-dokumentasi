...
hero:
    image:
        file: '../../../assets/index-kartu-presensi.webp'
...
<CardGrid>
    <Card title='Presensi Cepat' icon='rocket'>
        Tap kartu di reader RFID, presensi langsung tercatat dalam hitungan
        detik
    </Card>
    <Card title='Akurat & Real-time' icon='approve-check'>
        Data presensi langsung masuk ke sistem dan dapat dipantau secara
        real-time
    </Card>
    <Card title='Anti Manipulasi' icon='warning'>
        Setiap kartu memiliki ID unik yang tidak dapat diduplikasi atau
        dipalsukan
    </Card>
...
<Aside type='caution' title='Tips Merawat Kartu'>
    - Simpan di tempat yang aman (dompet, card holder) - Jangan ditekuk,
    direndam air, atau terkena panas - Pasang lanyard agar tidak mudah hilang -
    Hindari kontak dengan magnet atau benda tajam
</Aside>
...
<Card title='Unique ID' icon='approve-check'>
    Setiap kartu memiliki ID unik yang terdaftar di sistem, tidak bisa
    diduplikasi
</Card>
