...
<TabItem label='Kelompok B (Umum)'>
    **Mata Pelajaran Penunjang** - Seni Budaya - Pendidikan Jasmani, Olahraga,
...
<TabItem label='Multiple Pengampu'>
    **Beberapa Guru untuk Kelas Berbeda** Cocok untuk: - Mapel dengan banyak
    rombel - Pembagian beban mengajar Contoh: - Guru A: Matematika VII Unggulan,
    2 - Guru B: Matematika X Unggulan3, 4
</TabItem>
...
<Aside type='note'>
    Total beban belajar siswa dalam seminggu disesuaikan dengan struktur
    kurikulum yang berlaku (Kurikulum 2013 atau Kurikulum Merdeka).
</Aside>
